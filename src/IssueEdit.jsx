...
import { FormGroup, FormControl, ControlLabel, ButtonToolbar, Button, Panel, Form, Col, Alert }
      ...
      <Panel header="Edit Issue">
        <Form horizontal onSubmit={this.onSubmit}>
          ...
          <FormGroup>
            ...
            <Col sm={9}>
              <FormControl componentClass="select" name="status" value={issue.status}
        ...
        <Toast showing={this.state.toastVisible} message={this.state.toastMessage}
          onDismiss={this.dismissToast} bsStyle={this.state.toastType}></Toast>
      </Panel>
    );
  }
}
